...
$(function(){
	$('.msw_banner>p').click(function(event) {
		$('.msw_banner ul').toggleClass('baulshow');
	});

	$('.b_max').click(function(event) {
		$('.banner_show').removeClass('show_none');
	});
	$('.b_max1').click(function(event) {
		$('.banner_show').addClass('show_none');
	});

	$('.main_max').hover(function() {
		$(this).children('.max_showhover').addClass('hover');
	}, function() {
		$(this).children('.max_showhover').removeClass('hover');	});

	$('.i').click(function(event) {
		$(this).toggleClass('ihover');
		$(this).parent().siblings().children('i').toggleClass('ihover');
	});
