...
$(function(){
	$('.msw_row .bg').hover(function() {
		$(this).children().children('.maxhover').addClass('hover')
	}, function() {
		$(this).children().children('.maxhover').removeClass('hover')
	});
	$('.w_fluid>span').click(function(event) {
		$('html,body').animate({
			'scrollTop': '0'
