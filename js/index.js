...
* @Date:   2021-07-08 09:23:08
* @Last Modified by:   Administrator
* @Last Modified time: 2021-07-22 18:12:47
*/
...
$(window).scroll(function(e){
	if($(window).scrollTop()>=$('.product_item.yjf_2').offset().top&&
		$(window).scrollTop()<=$('.product_item.yjf_3').offset().top)
	{
		if($('.product_item.yjf_2 .product_detail.detail_right').children('.txt').css('display')=='block')
		{
			 p=$(this).scrollTop();
			 if(t<=p){
		    	num_detail--;
		        $('.product_detail.detail_left').css('margin-top',num_detail*10+'px');
		         $('.product_detail.detail_right').css('margin-top',num_detail*5+'px');
		    }
		    else{
		    	num_detail++;
		         $('.product_detail.detail_left').css('margin-top',num_detail*15+'px');
		         $('.product_detail.detail_right').css('margin-top',num_detail*3+'px');
		    }
		    t = p;
		}
